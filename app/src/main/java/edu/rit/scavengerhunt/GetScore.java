...
public class GetScore {
    ...
    public String newScore(String team_name) {

        new Get_Score().execute(team_name);
        while (data == null) {
    ...
    public class Get_Score extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://www.noella.kolash.org/hcin722/getScore.php");
